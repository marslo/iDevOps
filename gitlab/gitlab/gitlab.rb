...
external_url 'http://pww.gitlab.cdi.mygitlab.com'
...
# Incomming Mail Server Setup - Marslo
gitlab_rails['incoming_email_enabled'] = true
...
gitlab_rails['gitlab_email_from'] = 'my.gitlab.account@mygitlab.com'
gitlab_rails['gitlab_email_reply_to'] = 'my.gitlab.account@mygitlab.com'


# SMTP for @mygitlab.com
gitlab_rails['smtp_enable'] = true
gitlab_rails['smtp_address'] = 'smtprelay-asp1.mygitlab.com'
gitlab_rails['smtp_port'] = 25
gitlab_rails['smtp_user_name'] = 'my.gitlab.account@mygitlab.com'
gitlab_rails['smtp_password'] = 'mypassword'
gitlab_rails['smtp_domain'] = 'mygitlab.com'
# gitlab_rails['smtp_domain'] = 'CODE1.EMI.mygitlab.com'
...
# Inspired at https://gitlab.com/gitlab-org/gitlab-ce/issues/1558#note_1183160
# https://github.com/mikel/mail/blob/master/lib/mail/network/delivery_methods/smtp.rb#L135
...
user['git_user_email'] = "my.gitlab.account@mygitlab.com"
